...
Меня зовут Никита, я бэкенд-разработчик, на работе разрабатываю апи на php/Laravel/PostgreSQL, внерабочее время пишу код на Go и учусь в Яндекс.Практикуме
